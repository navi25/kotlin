...
DECIMAL_INTEGER_LITERAL=(0|([1-9]({DIGIT_OR_UNDERSCORE})*))({LONG_SUFFIX}|{UNSIGNED_SUFFIX}|{UNSIGNED_LONG_SUFFIX})?
HEX_INTEGER_LITERAL=0[Xx]({HEX_DIGIT_OR_UNDERSCORE})*({LONG_SUFFIX}|{UNSIGNED_SUFFIX}|{UNSIGNED_LONG_SUFFIX})?
BIN_INTEGER_LITERAL=0[Bb]({DIGIT_OR_UNDERSCORE})*({LONG_SUFFIX}|{UNSIGNED_SUFFIX}|{UNSIGNED_LONG_SUFFIX})?
LONG_SUFFIX=[Ll]
UNSIGNED_SUFFIX=[Uu]
UNSIGNED_LONG_SUFFIX={UNSIGNED_SUFFIX}{LONG_SUFFIX}
